...
export default function Login() {
    ...
    return (
        <div className="flex flex-col h-screen overflow-hidden bg-background">
            ...
            <main className="flex-grow flex flex-col md:flex-row w-full overflow-hidden">
                <section className="hidden md:flex md:w-1/2 relative bg-surface-container-low items-center justify-center p-2xl h-full">
                    ...
                    <div className="relative z-10 max-w-lg mt-auto pb-3xl">
                        <h1 className="font-headline-lg text-headline-lg text-on-surface mb-sm">Clarity from Chaos.</h1>
                ...
                <section className="w-full md:w-1/2 flex items-center justify-center p-margin-mobile md:p-margin-desktop pt-3xl md:pt-margin-desktop bg-surface overflow-y-auto h-full">
                    <div className="w-full max-w-md glass-panel rounded-[24px] p-xl md:p-2xl fade-in" id="auth-container">
                        ...
                        <div
                            className={`mb-md p-md bg-error-container text-on-error-container rounded-xl font-body-sm text-body-sm border border-error/20 items-start gap-sm ${displayError ? 'flex' : 'hidden'}`}
                            id="error-message"
                        >
                            <span className="material-symbols-outlined text-error" style={{ fontVariationSettings: '"FILL" 1', fontSize: '18px' }}>error</span>
                        ...
                        <form className="space-y-lg" id="login-form" onSubmit={handleSubmit}>
                            {isRegistering && (
                                <div className="space-y-xs">
                                    ...
                                    <div className="relative">
                                        <span className="absolute left-md top-1/2 -translate-y-1/2 material-symbols-outlined text-outline" style={{ fontSize: "18px" }}>person</span>
                                        <input
                                            className="w-full pl-2xl pr-md py-md bg-surface-container-low rounded-xl font-body-base text-body-base text-on-surface placeholder:text-outline input-glow"
                                            id="name"
                                            name="name"
                                            placeholder="Name"
                            ...
                            <div className="space-y-xs">
                                ...
                                <div className="relative">
                                    <span className="absolute left-md top-1/2 -translate-y-1/2 material-symbols-outlined text-outline" style={{ fontSize: "18px" }}>mail</span>
                                    <input
                                        className="w-full pl-2xl pr-md py-md bg-surface-container-low rounded-xl font-body-base text-body-base text-on-surface placeholder:text-outline input-glow"
                                        id="email"
                                        name="email"
                            ...
                            <div className="space-y-xs">
                                ...
                                <div className="relative">
                                    <span className="absolute left-md top-1/2 -translate-y-1/2 material-symbols-outlined text-outline" style={{ fontSize: "18px" }}>lock</span>
                                    <input
                                        className="w-full pl-2xl pr-md py-md bg-surface-container-low rounded-xl font-body-base text-body-base text-on-surface placeholder:text-outline input-glow"
                                        id="password"
                                        name="password"
            ...
            <footer className="w-full py-lg px-margin-desktop flex justify-center items-center bg-surface border-t border-outline-variant/8">
                <span className="font-body-sm text-body-sm text-secondary/60">
